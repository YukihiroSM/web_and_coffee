  ...
  return (
    <Container maxW='4xl' mx='auto' my={8}>
      ...
      <Text fontSize='lg' mb={4}>
        We are a modern team of developers who want to support others. Our
        website is a huge storage of different projects and people who are doing
        them. We have different types of projects and our main scope is of
        course development. User can create their own project or join other. It
      ...
      >
        <Text fontSize='lg' fontStyle='italic' mb={2}>
          "I have found some great projects to work on and met some amazing
          people through this website. Highly recommend it to anyone looking to
          collaborate on development projects." - John Doe
        </Text>
